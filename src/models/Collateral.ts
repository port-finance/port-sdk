...
export class Collateral {
  ...
  private constructor(reserveId: ReserveId, share: Share, recordedValue: QuoteValue) {
    this.reserveId = reserveId;
    this.share = share;
    this.recordedValue = recordedValue;
  }

  public static fromRaw(raw: PortBalanceCollateralData, shareId: ShareId): Collateral {
    ...
    return new Collateral(new ReserveId(raw.depositReserve), lamport, recordedValue);
  }
