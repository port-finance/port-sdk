...
export class Asset extends Lamport<AssetId, Asset> {
  ...
  public static fromString(str: string, assetId: AssetId, context: AssetQuantityContext): Asset {
  ...
  static async fetchMinRentExempt(connection: Connection, dataLength: number): Promise<Asset> {
  ...
  public toValue(price: AssetPrice, quantityContext: AssetQuantityContext): QuoteValue {
